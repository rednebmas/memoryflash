...
import { logout } from '../../submodules/MemoryFlashCore/src/redux/actions/logout-action';
...
export const AccountScreen: React.FC<AccountScreenProps> = () => {
	...
	return (
		<Layout>
			<main>
				<h3 className='px-4 mb-2 lg:px-8 text-sm font-normal leading-6 text-gray-400'>PROFILE</h3>
						...
						<div>
							<dl className='mt-0 divide-y divide-gray-100 text-sm leading-6'>
								<ProfileRow
									...
									onUpdate={() => openModal('firstName', 'First name', profileData.firstName)}
								/>
								<ProfileRow
									label='Last name'
									value={profileData.lastName}
									onUpdate={() => openModal('lastName', 'Last name', profileData.lastName)}
								/>
