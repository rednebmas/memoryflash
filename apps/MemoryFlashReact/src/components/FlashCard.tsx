...
import { CardWithAttempts } from '../submodules/MemoryFlashCore/src/redux/selectors/currDeckCardsWithAttempts';
import { useAppSelector } from '../submodules/MemoryFlashCore/src/redux/store';
import { CardTypeEnum, IntervalCard } from '../submodules/MemoryFlashCore/src/types/Cards';
		...
		return (
			...
			>
				...
				{card?.attempts?.length > 0 && (
					<span className='text-xs text-gray-600'>{card.attempts[0].timeTaken.toFixed(1)}s</span>
				)}
